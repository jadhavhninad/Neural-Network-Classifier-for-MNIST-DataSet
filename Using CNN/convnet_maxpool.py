...
def multi_layer_backward(dAL, caches, parameters,mp_cache,ch, convLcount=1):
    '''
...
def multi_layer_network(X, y, net_dims,  num_iterations=10, learning_rate=0.1):
    ...
    for ii in range(200):
        #print("forward prop")
        AL, caches, mp_cache = multi_layer_forward(X, parameters,ch,1)
        ...
        gradients = multi_layer_backward(dZ, caches, parameters,mp_cache,ch)
